        ...
        <div className="col-span-6 mt-20 p-8">
            ...
            >
                ...
                >
                    ...
                    <option value="cheapest_price">
                        Price: Low to High
                    </option>
                    <option value="most_expensive">
                        Price: High to Low
                    </option>
                    <option value="ascending_alphabet">
                        Alphabet A-Z
                    </option>
                    <option value="descending_alphabet">
                        Alphabet Z-A
                    </option>
                </select>
            </div>
                ...
                {products.map((product, index) => (
                    ...
                    >
                        <div className="mt-2 group">
                            <div className="relative bg-white rounded-2xl border border-[#E5E5E5] overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
